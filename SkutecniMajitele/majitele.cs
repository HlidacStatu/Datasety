    ...
    public class majitele
    {
        public void UpdateOsobaId()
        {
            if (this.skutecni_majitele != null)
            {
                ...
                {
                    string nameid = GetOsobaId(this.skutecni_majitele[i]);
                    this.skutecni_majitele[i].osobaId = nameid;
        ...
        public static string GetOsobaId(majitel_base maj)
        {
            ...
            try
            {
                osobaid = findPerson.GetOsobaId(maj.osoba_jmeno, maj.osoba_prijmeni, maj.osoba_datum_narozeni);
            }
            catch (Exception)
            {
